...
GOVERNED_CASES = (
    ...
    ("C04_PK_FIELD_MODULUS_BAD_ENCODING", 1, 3, 0, STIMULUS_WRITE_ALL_THEN_CLOSE),
    ...
    ("C08_SIG_FIELD_MODULUS_BAD_ENCODING", 1, 7, 0, STIMULUS_WRITE_ALL_THEN_CLOSE),
...
CONSTRUCTION_INTENT = {
    ...
    "C04_PK_FIELD_MODULUS_BAD_ENCODING": "G2_X_COORDINATE_GREATER_OR_EQUAL_FIELD_MODULUS",
    ...
    "C08_SIG_FIELD_MODULUS_BAD_ENCODING": "G1_X_COORDINATE_GREATER_OR_EQUAL_FIELD_MODULUS",
