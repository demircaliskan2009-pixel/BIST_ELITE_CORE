...
TRUSTED_CASE_INVENTORY = (
    ...
    (
        4,
        "C04_PK_FIELD_MODULUS_BAD_ENCODING",
    ...
    (
        8,
        "C08_SIG_FIELD_MODULUS_BAD_ENCODING",
...
EXPECTED_CASE_SET_DIGEST = "a0d9e3a25858d2a54d89083241499119b1ca0653b6de98fa6236dd4da9542c37"
