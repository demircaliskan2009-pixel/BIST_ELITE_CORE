...
fact; replacing the section 24.4 acceptance audit, the connector final gate, tests/CI, or post-merge
verification.
...
justify skipping tests/CI/audit; replace the connector final gate, the section 24.4 acceptance audit,
tests/CI, or local post-merge verification; authorize live/private API/order routing or any forbidden
surface; weaken a
