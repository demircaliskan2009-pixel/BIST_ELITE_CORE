...
1. `run_reported_head` is METADATA. It is never assumed to be `actual_checkout_revision`.
...
atomic against an authorized administrator change; or that a manifest satisfying the JSON Schema has
