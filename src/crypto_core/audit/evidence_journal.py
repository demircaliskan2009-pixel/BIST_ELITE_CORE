...
class EvidenceArtifactType(str, Enum):
    ...
    PAPER_TRADE_TICK = "PAPER_TRADE_TICK"
    PAPER_SLEEVE_RISK_BUDGET_DECISION = "PAPER_SLEEVE_RISK_BUDGET_DECISION"
    PAPER_SLEEVE_PROMOTION_CANDIDATE = "PAPER_SLEEVE_PROMOTION_CANDIDATE"
    PAPER_SLEEVE_PROMOTION_READINESS = "PAPER_SLEEVE_PROMOTION_READINESS"
    PAPER_EVIDENCE_ADMISSION_RECORD = "PAPER_EVIDENCE_ADMISSION_RECORD"
