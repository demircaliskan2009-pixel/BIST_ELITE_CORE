"""Tests for the governed historical execution-economics policy (DETERMINISTIC_HISTORICAL_EXECUTION_ECONOMICS_V1).
...
def test_policy_commits_every_v1_identity_and_value() -> None:
