...
from tests.crypto_core.venue.test_phase61b_paper_promoted_runtime_readiness_artifact import _runtime_readiness
...
def test_phase61h_next_blocker_summary_records_current_readiness_state() -> None:
...
def test_phase61h_next_blocker_summary_records_runtime_readiness_state() -> None:
...
def test_phase61h_next_blocker_summary_points_to_runtime_wiring_gate() -> None:
    text = _normalized_summary_text()

    assert "PAPER_PROMOTED_RUNTIME_WIRING_NOT_READY" in text
