...
from tests.crypto_core.venue.test_phase78b_paper_runtime_heartbeat_provenance_gate_continuity_artifact import (
    _json,
)

SUMMARY = Path("docs/crypto_core/DERIBIT_NEXT_BLOCKER_SUMMARY_78H.md")
...
def test_phase78h_summary_records_current_readiness_state() -> None:
...
def test_phase78h_summary_records_provenance_gate_continuity() -> None:
...
def test_phase78h_summary_points_to_next_blocker() -> None:
    text = _normalized_summary_text()
