...
PHASE39_FILES = (
    Path("docs/crypto_core/PAPER_TRADE_AUDIT_REPORTING_GATE_39A.md"),
    Path("docs/crypto_core/DERIBIT_FIRST_PAPER_TRADE_AUDIT_REPORT_39B.json"),
    Path("docs/crypto_core/DERIBIT_NEXT_BLOCKER_SUMMARY_39H.md"),
)


def test_phase39f_connector_ready_dialect_and_validator_state_are_preserved() -> None:
...
def test_phase39f_public_feed_dialects_source_is_not_changed_for_phase39() -> None:
...
def test_phase39f_phase39_files_have_no_bist_leakage() -> None:
    for path in PHASE39_FILES:
