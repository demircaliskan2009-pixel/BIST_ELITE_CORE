...
from tests.crypto_core.venue.test_phase56b_operator_promotion_review_proposal_artifact import _proposal


def test_phase56e_proposal_contains_no_secret_endpoint_or_execution_material() -> None:
...
def test_phase56e_scope_flags_remain_disabled_and_safety_flags_remain_true() -> None:
    proposal = _proposal()
