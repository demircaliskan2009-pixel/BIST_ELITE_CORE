...
from tests.crypto_core.venue.test_phase65b_approved_paper_runtime_enablement_artifact import _execution
...
def test_phase65h_next_blocker_summary_records_current_readiness_state() -> None:
...
def test_phase65h_next_blocker_summary_records_execution_state() -> None:
...
def test_phase65h_next_blocker_summary_points_to_runtime_start_proposal_gate() -> None:
    text = _normalized_summary_text()

    assert "PAPER_RUNTIME_START_PROPOSAL_NOT_READY" in text
