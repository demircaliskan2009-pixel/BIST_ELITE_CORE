...
def test_phase74e_no_live_scope_in_helper_output() -> None:
...
def test_phase74e_no_live_scope_in_artifact() -> None:
    art = _json(ARTIFACT)
...
def test_phase74e_no_mutation_and_no_strategy_output() -> None:
    art = _json(ARTIFACT)
