...
from tests.crypto_core.venue.test_phase70b_paper_runtime_heartbeat_artifact import _artifact

SUMMARY = Path("docs/crypto_core/DERIBIT_NEXT_BLOCKER_SUMMARY_70H.md")
...
def test_phase70h_next_blocker_summary_records_current_readiness_state() -> None:
...
def test_phase70h_next_blocker_summary_records_runtime_heartbeat_state() -> None:
...
def test_phase70h_next_blocker_summary_points_to_heartbeat_telemetry_gate() -> None:
    text = _normalized_summary_text()
