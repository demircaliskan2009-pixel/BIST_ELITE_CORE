...
def test_build_chat_result_via_advisor_preserves_dynamic_live_payload_on_dataclass_advice() -> None:
...
def test_build_chat_result_via_advisor_keeps_sane_dynamic_live_payload_on_dataclass_advice() -> None:
    original = advisor_mod.build_advice_for_symbol
