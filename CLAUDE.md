...
(`CLASS_C_LANE_REQUIRED_BUT_UNAVAILABLE`, canonical sections 3.4 and 10.1). Report the capacity reading
...
- Protected Class-C work always gets a fresh-context independent audit from the protected frontier
  lane (canonical sections 3.4 and 12). A Claude session never satisfies it.
